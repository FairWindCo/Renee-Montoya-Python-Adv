...
--
-- Host: localhost    Database: ms_2021100109pegt7ncwku85zprb
-- ------------------------------------------------------
...
INSERT INTO `phone_companies` VALUES (5,'xiaomi'),(6,'apple'),(7,'samsung');
...
CREATE TABLE `phones` (
  `id` int NOT NULL AUTO_INCREMENT,
  `phone_name` char(10) DEFAULT NULL,
...
INSERT INTO `phones` VALUES (5,'+432432432',1,1),(6,'+54654767',1,3),(7,'+657356567',1,4);
...
-- Dump completed on 2021-10-01  9:32:14
